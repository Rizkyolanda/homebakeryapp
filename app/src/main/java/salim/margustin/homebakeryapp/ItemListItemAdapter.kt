...
class ItemListItemAdapter(val context: Context, val layout: Int, val itemList: ArrayList<Item>) :
    BaseAdapter() {
    ...
    override fun getView(position: Int, view: View, viewGroup: ViewGroup): View {
        ...
        if (row == null) {
            ...
            holder.txtIngredient = row!!.findViewById<View>(R.id.txtIngredient) as TextView
            holder.txtRecipes = row!!.findViewById<View>(R.id.txtRecipes) as TextView
